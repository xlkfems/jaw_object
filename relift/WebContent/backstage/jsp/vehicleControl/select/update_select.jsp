...
<div class="layui-form-item" style="margin-top: 20px">
    <form class="layui-form" action="<%=basePath%>contractServlet?oper=update_alter" method="post" id="cargoReceiptForm">
        <div class="layui-form-item">
            <label class="layui-form-label wd-100">货运回执单编号</label>
            <div class="layui-input-inline">
                <input type="text" id="goodsRevertBillCode" value="${contract.fre_number}" name="goodsRevertBillCode" readonly lay-verify="required"
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="loadStation" value="${contract.make}" name="loadStation"  lay-verify="required" placeholder="请输入装货地点"
                           autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-inline">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="dealGoodsStation" value="${contract.make_receipt}" name="dealGoodsStation"  placeholder="请输入交货地点"
                           autocomplete="off" class="layui-input">
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="allCarriage" value="${contract.con_freight}" name="allCarriage"  lay-verify="required|number" placeholder="请输入总运费"
                           autocomplete="off" class="layui-input">
                </div>
            </div>
        </div>
