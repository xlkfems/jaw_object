        ...
        <div class="layui-tab-item layui-show">
		  ...
		  <tr>
    	    ...
    	    <tr>
    	       ...
    	       <td>上海</td>
    	       <td>
    	       <button type="button" class="layui-btn layui-btn-sm layui-btn-normal" onclick="phone('以提回告','../phone.jsp','800','500')">回告客户</button>    
    	       </td>
    	   </tr>
    	</table>
        </div>
...
<script src="../../../js/customerService/got/informGot.js"></script>
